...
public class NewspapersController : Controller
{
    ...
    public NewspapersController(IRepository<Newspaper> repository)
    {
    ...
    public async Task<IActionResult> Create(Newspaper entity)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(int id, Newspaper entity)
    {
